...
public class DragonGame {
    public static void main(String[] args) {
        ...
        dragones[3] = new Dragon("Eructo y Guácara", 100, 12, "Tierra", 18);
        dragones[4] = new Dragon("Albóndiga", 100, 8, "Fuego", 17);
                    ...
                    if (turnoJugador) {
                        ...
                        switch (accion) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                dragon1.defenderse(jinete2);
                                break;
                            case 4:
                                dragon1.volar(jinete2);
                                break;
                            default:
                        ...
                        switch (accion) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                dragon2.defenderse(jinete1);
                                break;
                            case 4:
                                dragon2.volar(jinete1);
                                break;
                            default:
                                System.out.println("Opción no válida.");
                        }
        ...
        turnoJugador = !turnoJugador;  // Cambiar de turno
        }
